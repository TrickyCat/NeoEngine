...
module ``Tests For Parser Of A Non-Empty Tail Of String`` =
    ...
    let private successTestData: obj [][] = [|
        [|      "Some End Of Template With No Neo customizations open tags left";
        ...
        [|      @"परिवहन तकनिकल व्यवहार कार्य भाति उद्योग लक्ष्य अत्यंत जिसे विकास उपेक्ष विश्वास कार्यकर्ता सं";
            Str @"परिवहन तकनिकल व्यवहार कार्य भाति उद्योग लक्ष्य अत्यंत जिसे विकास उपेक्ष विश्वास कार्यकर्ता सं" |]

        [|      @"復案ぼへびえ焦集エメシホ方知経ヨマヒモ縮";
            Str @"復案ぼへびえ焦集エメシホ方知経ヨマヒモ縮" |]

        [|      "some text before <%";
            Str "some text before <%" |]

        [|      "another text before <%= smth %>word<%";
