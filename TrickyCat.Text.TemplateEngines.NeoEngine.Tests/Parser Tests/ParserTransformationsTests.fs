...
module ``Parser Transformations Tests`` =
    ...
    let private successTestData: obj [] seq = seq {
        yield [| [Str "hello"]; (Ok [Str2 "hello"]) :> T |]
        yield [| [Str "hello"; Str "world"]; (Ok [Str2 "hello"; Str2 "world"]) :> T |]
        yield [| [Neo "hello"]; (Ok [Neo2 "hello"]) :> T |]
        yield [| [NeoSubstitute "hello"]; (Ok [NeoSubstitute2 "hello"]) :> T |]
        yield [| [NeoIncludeView "hello"]; (Ok [NeoIncludeView2 "hello"]) :> T |]
        
        yield [| [NeoIfElseTemplate { condition = "p"; ifBranchBody = []; elseBranchBody = None }];
             (Ok [NeoIfElseTemplate2 { condition2 = "p"; ifBranchBody2 = []; elseBranchBody2 = None }]) :> T |]

        yield [| [NeoIfElseTemplate { condition = "p"; ifBranchBody = [Str "hello"]; elseBranchBody = None }];
             (Ok [NeoIfElseTemplate2 { condition2 = "p"; ifBranchBody2 = [Str2 "hello"]; elseBranchBody2 = None }]) :> T |]

        yield [| [NeoIfElseTemplate { condition = "p"; ifBranchBody = [Str "hello"; Neo "a"]; elseBranchBody = None }];
            (Ok [NeoIfElseTemplate2 { condition2 = "p"; ifBranchBody2 = [Str2 "hello"; Neo2 "a"]; elseBranchBody2 = None }]) :> T |]

        yield [| [NeoIfElseTemplate { condition = "p"; ifBranchBody = [Str "hello"; Neo "a"]; elseBranchBody = Some <| [Str "world"; Neo "b"] }];
            (Ok [NeoIfElseTemplate2 { condition2 = "p"; ifBranchBody2 = [Str2 "hello"; Neo2 "a"]; elseBranchBody2 = Some <| [Str2 "world"; Neo2 "b"]  }]) :> T |]
        ...
        yield [| [NeoIfElseTemplate {
            ...
            (Ok [NeoIfElseTemplate2 {
                condition2 = "p"
                ifBranchBody2 = [
                    Str2 "hello"
                    Neo2 "a"
                    NeoIfElseTemplate2 { condition2 = "c"; ifBranchBody2 = [Str2 "inside"; Neo2 "foo"]; elseBranchBody2 = None }
                    ]
                elseBranchBody2 = None
                }]
                ) :> T |]
        ...
        yield [| [NeoIfElseTemplate {
            ...
            (Ok [NeoIfElseTemplate2 {
                ...
                elseBranchBody2 = Some <| [
                    Str2 "hello"
                    Neo2 "a"
                    NeoIfElseTemplate2 { condition2 = "c"; ifBranchBody2 = [Str2 "inside"; Neo2 "foo"]; elseBranchBody2 = Some <| [Str2 "1"]}
                ]
                }]
                ) :> T |]
        ...
        yield [| [NeoIfElseTemplate {
            ...
            (Ok [NeoIfElseTemplate2 {
                ...
                ifBranchBody2 = [
                    Str2 "hello"
                    Neo2 "a"
                    NeoIfElseTemplate2 { condition2 = "c"; ifBranchBody2 = [
                        Str2 "inside"
                        Neo2 "foo"
                        NeoIfElseTemplate2 { condition2 = "c2"; ifBranchBody2 = [Str2 "inside2"; Neo2 "foo2"]; elseBranchBody2 = None }
                        ]; elseBranchBody2 = None }
                    ]
                elseBranchBody2 = None
                }]
